      ...
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item" href="employes.php">Liste des employés</a></li>
            <li><a class="dropdown-item" href="archives.php">Employés archivés</a></li>
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item" href="congesRH.php">consulter les Congés</a></li>
            <li><a class="dropdown-item" href="congesdemandes.php">demandeurs de congés</a></li>
